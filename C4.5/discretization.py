"""This module implements commonly used discretization algorithms, including both 
supervised ones and unsupervised ones. 

Supervised discretization algorithms: the famous entropy-based discretization
Unsupervised........................: equal-interval, and equal-frequency bin

author: Fan Feng
Email: 18817598306@163.com
"""
...
class MDLP_Discretizer(object):
    ...
    def apply_cutpoints(self, out_data_path=None, out_bins_path=None):
        ...
        # divide the origin dataset to subsets.
        cut_Points = []
        point = -np.inf 
        for attr in self._features:
